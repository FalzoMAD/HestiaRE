...
software="acl apache2 apache2-suexec-custom apache2-utils at awstats bc bsdmainutils bsdutils
  ...
  postgresql postgresql-contrib proftpd-basic quota rrdtool rsyslog
  sysstat unrar-free unzip util-linux vim-common xxd whois zip zstd bubblewrap restic"
