...
if grep "geoip2" $HESTIA/templates/web/awstats/awstats.tpl; then
...
if [ -d /etc/awstats ]; then
	...
	echo "LoadPlugin=\"geoip2_country /usr/share/GeoIP/GeoLite2-Country.mmdb\"" >> $HESTIA/templates/web/awstats/awstats.tpl
