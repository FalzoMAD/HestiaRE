...
$root_path = getenv('FM_ROOT') ?: $_SERVER['DOCUMENT_ROOT'];
...
// abs path for site
defined('FM_ROOT_URL') || define('FM_ROOT_URL', (!empty($root_url) ? '/' . $root_url : ''));
defined('FM_SELF_URL') || define('FM_SELF_URL', $_SERVER['PHP_SELF']);
